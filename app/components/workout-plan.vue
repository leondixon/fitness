...
<template>
  <section class="mx-auto grid w-full max-w-[860px] gap-3">
    <header class="rounded-2xl border border-slate-200 bg-slate-950 p-4 text-white shadow-[0_10px_30px_rgb(15_23_42_/_12%)] sm:p-5">
    ...
    <div class="grid gap-3">
      <button
        ...
        class="w-full rounded-2xl border border-slate-200 bg-white p-3 text-left shadow-[0_10px_30px_rgb(15_23_42_/_7%)] transition hover:-translate-y-0.5 hover:border-emerald-300 hover:shadow-[0_16px_40px_rgb(15_23_42_/_10%)] focus:outline-none focus:ring-2 focus:ring-emerald-500 sm:p-4"
        type="button"
      ...
      >
        <div class="flex items-start justify-between gap-3">
          <div class="min-w-0">
            ...
            <h2 class="truncate text-xl font-bold leading-tight text-slate-900">
              {{ workout.title }}
            </h2>
            <p v-if="workout.focus" class="mt-1 truncate text-xs font-semibold text-slate-500">
              {{ workout.focus }}
            </p>
          </div>

          <div class="shrink-0 rounded-xl bg-emerald-50 px-3 py-2 text-right text-emerald-900 ring-1 ring-emerald-100">
            <p class="text-[0.6rem] font-bold uppercase tracking-[0.08em] text-emerald-700">
              Est
            </p>
        ...
        <div class="mt-3 grid grid-cols-2 gap-1.5 text-center">
          <div class="rounded-xl bg-slate-50 px-2 py-1.5">
            <p class="text-[0.6rem] font-bold uppercase tracking-[0.08em] text-slate-500">
              Exercises
            </p>
            <p class="text-lg font-black leading-tight text-slate-900">
